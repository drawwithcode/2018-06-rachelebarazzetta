...
function page2() {
  ...
  var newBall3 = new Ball(windowWidth / 2, windowHeight / 2, 200, myImage5, );
  balls.push(newBall3);

  var newBall4 = new Ball(windowWidth / 2 - 300, windowHeight / 2, 200, myImage7, );
  balls.push(newBall4);

  var newBall5 = new Ball(windowWidth / 2 + 300, windowHeight / 2, 200, myImage6, );
  balls.push(newBall5);
